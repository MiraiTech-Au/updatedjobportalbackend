...
import { moduleNames, responseType } from "../../utils/enums.js";
...
export const sendOTP = async (req, res) => {
  try {
    ...
    successResponse(res, 200, "OTP sent successfully", null);
  } catch (err) {
    errorResponse(res, 500, responseType[4], err.message);
  }
};
...
export const signUp = async (req, res) => {
  try {
    ...
    successResponse(res, 201, "Signup successful", savedUser);
...
export const updateEmployee = async (req, res) => {
  try {
    ...
    if (!updatedUser) {
      ...
      successResponse(res, 200, "User update successfully", updatedUser);
...
export const uploadProfilePicture = async (req, res) => {
  try {
    ...
    successResponse(res, 200, "Profile picture updated successfully", user);
  } catch (error) {
    errorResponse(res, 500, error.message);
  }
};
...
export const uploadNewResume = async (req, res) => {
  try {
    ...
    successResponse(res, 200, "Resume uploaded successfully", updatedEmployee);
  } catch (error) {
    errorResponse(res, 500, error.message);
  }
};
...
export const getProfileDetailsById = async (req, res) => {
  try {
    ...
    successResponse(res, 200, "Profile details get successfully", employee);
  } catch (err) {
    logger.error(
...
export const getUser = async (req, res) => {
  try {
    ...
    logger.info(`${moduleNames[0]} - Get. Success:${JSON.stringify(user)}`);
    successResponse(res, 200, "User get successfully", user);
  } catch (error) {
...
export const saveEmployee = async (req, res) => {
  try {
    ...
    successResponse(res, 200, "User save successfully", savedUser);
  } catch (error) {
    logger.error(
      `${moduleNames[0]} - Update-Status:${400}, Error:${JSON.stringify(
        error.message
